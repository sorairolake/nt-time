...
* Add `FileTime::to_unix_duration` ({pull-request-url}/489[#489])
* Add `FileTime::from_unix_duration` ({pull-request-url}/489[#489])
...
* Use pass-by-value with types that implement the `Copy` trait
  ({pull-request-url}/453[#453])

== {compare-url}/v0.13.2\...v0.14.0[0.14.0] - 2026-02-20
...
* Remove `TryFrom<FileTime>` for `i64` ({pull-request-url}/437[#437])
* Remove `TryFrom<i64>` for `FileTime` ({pull-request-url}/437[#437])
* Remove `FileTime::from_str_radix` ({pull-request-url}/442[#442])
* Remove the formatting traits for `FileTime` except `fmt::Debug` and
  `fmt::Display` ({pull-request-url}/444[#444])

== {compare-url}/v0.13.1\...v0.13.2[0.13.2] - 2026-02-12

=== Changed

* Change to use derive to implement serde ({pull-request-url}/421[#421])
* Bump `rand` from 0.9.2 to 0.10.0 ({pull-request-url}/427[#427])

== {compare-url}/v0.13.0\...v0.13.1[0.13.1] - 2026-01-30

=== Changed

* Bump MSRV to 1.88.0 ({pull-request-url}/416[#416])
...
* Add `TryFrom<FileTime>` for `dos_date_time::DateTime`
  ({pull-request-url}/390[#390])
* Add `From<dos_date_time::DateTime>` for `FileTime`
  ({pull-request-url}/390[#390])

=== Changed

* Change the error message ({pull-request-url}/391[#391])
* Replace `time::OffsetDateTime` with `time::UtcDateTime`
  ({pull-request-url}/394[#394])
